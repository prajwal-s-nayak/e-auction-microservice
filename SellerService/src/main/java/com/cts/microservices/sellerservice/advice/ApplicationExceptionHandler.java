package com.cts.microservices.sellerservice.advice;
...
public class ApplicationExceptionHandler {
	...
	public Map<String,String> handleNotFoundException(ProductNotFoundException e){
		Map<String, String> errorMap= new HashMap<>();
	...
	public Map<String,String> handleErrorInDeleteingProduct(CannotDeleteProductException e){
		Map<String, String> errorMap= new HashMap<>();
		errorMap.put("errorMessage", e.getMessage());
		return errorMap;
	}
